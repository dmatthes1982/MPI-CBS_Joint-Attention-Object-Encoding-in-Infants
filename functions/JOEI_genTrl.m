function [ trl ] = JOEI_genTrl( cfg, data )
% JOEI_GENTRL is a function which generates a trl fragmentation of 
...
if mod(trlDuration, 2)
  ...
  trlLength = data.fsample * trlDuration / 1000;
end

numOfOrgTrials  = size(data.trialinfo, 1);
